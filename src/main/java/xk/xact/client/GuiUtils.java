...
//		}
	...
	@SideOnly(Side.CLIENT)
	public static void sendItemsToServer(NetHandlerPlayClient sendQueue, ItemStack[] items, int offset) {
		if( sendQueue == null )
			return;
	...
	public static int getMouseX(Minecraft minecraft) {
		ScaledResolution resolution = new ScaledResolution( minecraft.getMinecraft(), minecraft.displayWidth, minecraft.displayHeight );
