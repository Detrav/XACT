...
public class ReflectionUtils {
	...
	/**
	 * Whether if the object's class's simple name matches with the specified
	 * parameter.
	 *
	 * @param o
	...
	/**
	 * Tries to get a Class object based on the class' full name (includes
	 * package).
	 *
	 * @param classFullName
	 *            the name and package of the class, separated by dots.
	...
	/**
	 * Tries to create a new instance for the Class specified. The class must
	 * have a parameter-less constructor for this to work.
	 *
	 * @param clazz
	 *            The Class from which this will create an instance.
	 ...
	 * @param instance
	 *            the instance from where to read the field.
	 * @param <T>
	 *            the return type, described by <code>fieldType</code>
	 * @return the declared field (cast to the appropriate type), or null if it
	 *         couldn't be found.
	 */
	public static <T> T getFieldAs(Class clazz, String fieldName,
			Class<? extends T> fieldType, Object instance) {
	 ...
	 *         couldn't be found.
	 */
	public static <T> T getStaticFieldAs(Class clazz, String fieldName,
	 ...
	 * @param parameters
	 *            the type of the arguments this method takes.
	...
	/**
	 * Tries to invoke the specified instance method, passing the specified
	 * arguments into it.
	 *
	 * @param clazz
	 *            the class where the field is declared.
	 ...
	 *            the type of the arguments this method takes.
	 * @param instance
	 *            the instance from which the method is invoked
	 * @param args
	...
	public static Object invokeMethod(Class clazz, String methodName,
			Class[] parameters, Object instance, Object... args) {
	...
	/**
	 * Tries to invoke the specified static method, passing the specified
	 * arguments into it.
	 *
	 * @param clazz
	 *            the class where the field is declared.
