...
public class AEInventory { // implements IInventoryAdapter {
	...
	// if( item != null ) {
	// return convert( inventory.injectItems(convert( item ),
	...
	// if( iaeStack != null ) {
	// if (iaeStack.isItem())
	// return new ItemStack( ((IAEItemStack) iaeStack).getItem(), (int)
	// iaeStack.getStackSize(), ((IAEItemStack) iaeStack).getItemDamage() );
	//
	// }
	// return null;
	// }
	...
	//
	// private Iterator<IAEItemStack> iterator =
	// inventory.getAvailableItems(null).iterator();
	//
